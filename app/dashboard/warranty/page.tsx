...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .warranty-title { font-size: 13px; font-weight: 700; color: #f4991a; margin-bottom: 8px; display: flex; align-items: center; gap: 6px; }
...
<div class="header">
  ...
  <div class="contact">
    Kilimani, Padmore Residences B105, Nairobi, Kenya<br>
    Tel: 0735 838 597 | 0788 287 184
  </div>
</div>
...
<div class="meta">
  ...
  <div class="meta-item">
    ...
    <div class="meta-value">${new Date(inv.invoice_date).toLocaleDateString('en-GB', { day: '2-digit', month: 'long', year: 'numeric' })}</div>
  </div>
  <div class="meta-item">
    <div class="meta-label">Customer</div>
    <div class="meta-value">${inv.customer_name}</div>
    ${inv.customer_phone ? `<div style="font-size:11px;color:#888;margin-top:2px">${inv.customer_phone}</div>` : ''}
  </div>
</div>
      ...
      {showForm && (
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5 space-y-4">
          ...
          <div>
            ...
            <textarea value={warrantyText} onChange={e => setWarrantyText(e.target.value)} rows={4}
        ...
        {loading ? (
          ...
          <div key={inv.id} className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <div className="px-4 py-2.5">
              ...
              <p className="text-[10px] text-gray-400 mt-1 line-clamp-2">{inv.warranty_text}</p>
            </div>
          </div>
        ))}
      </div>
