...
import {
  Plug, Copy, RefreshCw, CheckCircle, ExternalLink,
  Code2, Globe, FileSpreadsheet, ShoppingBag, Zap,
  ChevronRight, Eye, EyeOff, AlertCircle, ArrowRight
} from 'lucide-react'
...
function DropifyGuide() {
  return (
    <div className="space-y-3">
      ...
      <p className="text-xs text-gray-500">Automatically send Dropify orders to Shipedo for COD delivery and fulfilment in Kenya.</p>
      <div className="space-y-2">
        {[
...
const integrations: Integration[] = [
  ...
  },
  {
    ...
    description: 'Automatically push WooCommerce orders to Shipedo for fulfillment and COD delivery in Kenya.',
    logo: <WordpressLogo />,
    status: 'disconnected',
    category: 'ecommerce',
    color: 'text-blue-700',
  ...
  },
  {
    id: 'google_sheets',
    name: 'Google Sheets',
    description: 'Sync all orders and COD data to Google Sheets automatically for easy reporting and reconciliation.',
  ...
  },
  {
    id: 'shopify',
    name: 'Shopify',
    description: 'Connect your Shopify store — new orders are instantly sent to Shipedo for same-day processing.',
    logo: <ShopifyLogo />,
    status: 'disconnected',
    category: 'ecommerce',
  ...
  },
  {
    id: 'youcan',
    name: 'YouCan',
    description: 'Integrate YouCan stores with Shipedo via webhook. Perfect for North African sellers targeting Kenya.',
    logo: <YouCanLogo />,
    status: 'disconnected',
    category: 'ecommerce',
  ...
  },
  {
    id: 'dropify',
    name: 'Dropify',
    description: 'Link your Dropify dropshipping store. Orders sync automatically for COD delivery and Kenya fulfilment.',
    logo: <DropifyLogo />,
    status: 'disconnected',
    category: 'ecommerce',
    color: 'text-sky-700',
...
export default function IntegrationsPage() {
  ...
  return (
    <div className="min-h-screen">
      <Header title="Integrations" subtitle="Connect Shipedo with your platforms" role="admin" />
