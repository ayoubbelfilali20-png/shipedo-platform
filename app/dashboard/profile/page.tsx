...
import {
  ...
  Plus, ShieldCheck, Camera, Building2
} from 'lucide-react'

const paymentMethods = [
  { id: 'pm1', type: 'bank',   label: 'Equity Bank',  account: '••••••4521', name: 'Shipedo Kenya Ltd', primary: true  },
  { id: 'pm2', type: 'mpesa',  label: 'M-Pesa Paybill', account: '174379',   name: 'Shipedo Kenya',    primary: false },
]
...
export default function AdminProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50/50">
      <Header title="Profile" subtitle="Your personal information & payment methods" />
      ...
      <div className="p-6 space-y-5 max-w-2xl">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 flex items-center gap-5">
          <div className="relative flex-shrink-0">
            <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-purple-500 to-purple-700 flex items-center justify-center text-white text-3xl font-bold shadow-lg">
              A
            </div>
          ...
          <div>
            <h2 className="text-xl font-bold text-[#1a1c3a]">Admin User</h2>
            <p className="text-sm text-gray-400 mt-0.5">admin@shipedo.co.ke</p>
            <span className="inline-flex items-center gap-1.5 mt-2 text-xs font-semibold px-2.5 py-1 rounded-full bg-purple-50 text-purple-700">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <Field label="Full Name"    value="Admin User"           icon={User}     />
            <Field label="Company"      value="Shipedo Kenya"        icon={Building2} />
            <Field label="Email"        value="admin@shipedo.co.ke"  type="email" icon={Mail}  />
            <Field label="Phone"        value="+254 700 000 000"     type="tel"   icon={Phone} />
            <Field label="City"         value="Nairobi"                           icon={MapPin} />
            <Field label="Address"      value="Westlands, Nairobi"               icon={MapPin} />
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          ...
          <div className="mt-4 p-3 bg-blue-50 border border-blue-100 rounded-xl flex items-start gap-2.5">
            ...
            <p className="text-xs text-blue-600">The <strong>primary</strong> method is used for platform fee collection and disbursements.</p>
          </div>
        </div>
