  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] flex">
      <div className="hidden lg:block">
        <Sidebar role="storage" collapsed={collapsed} onCollapsedChange={setCollapsed} />
      </div>
      ...
      {mobileSidebarOpen && (
        <div className="lg:hidden fixed inset-0 z-50 flex">
          ...
          <div className="relative z-10">
            <Sidebar role="storage" collapsed={false} onCollapsedChange={() => {}} />
      ...
      <div className={`flex-1 min-h-screen overflow-x-hidden transition-all duration-300 ${collapsed ? 'lg:ml-[68px]' : 'lg:ml-[240px]'}`}>
        <Header title="Storage" role="storage" onMenuToggle={() => setMobileSidebarOpen(true)} />
        {children}
